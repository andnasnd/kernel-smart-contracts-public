...
interface IHelioProvider {
    ...
    event WithdrawalInToken(address indexed owner, address indexed recipient, uint256 amount);
    ...
    function releaseInToken(address strategy, address recipient, uint256 amount) external returns (uint256);
